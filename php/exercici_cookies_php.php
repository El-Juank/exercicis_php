    ...
    <div class="container">
      ...
      <div class="navbar-languages">
        <form action='exercici_cookies_2_php.php' method='GET'>
          <button type='submit' name='es' value='es' class="<?php if ($_COOKIE["language"] == "es") {
                                                              echo "selected";
                                                            } ?>">ES</button>
          <button type='submit' name='en' value='ca' class="<?php if ($_COOKIE["language"] == "ca") {
                                                              echo "selected";
                                                            } ?>">CA</button>
          <button type='submit' name='en' value='en' class="<?php if ($_COOKIE["language"] == "en") {
                                                              echo "selected";
                                                            } ?>">EN</button>
        </form>
      </div>
