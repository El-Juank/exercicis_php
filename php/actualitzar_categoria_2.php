...
<body>
    ...
    <div class="category-insert container px-3 py-3 pt-md-5 pb-md-4 mt-md-5 mt-md-4 mx-auto">
        <div class="mb-md-4 mb-4">
            ...
            <?php $sql = "SELECT * FROM categories WHERE CategoryID=" . $_GET["category"];
            $categories = $conn->query($sql);
            $category = $categories->fetch_assoc();
            ?>

            <form method="POST" action="actualitzar_categoria.php">
                <label for="name">Name:</label>
                <input type="text" name="name" value="<?php echo $category["CategoryName"]; ?>" placeholder="Enter the new category name" id="name" class="form-control mb-3">
