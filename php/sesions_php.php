...
<head>
    ...
    <meta name="description" content="Permanència de dades (Sessió)" />
    <title>Permanència de dades (Sessió)</title>
...
<body>
    <div class="container">
        <?php $_SESSION["usuari"] = "Miquel"; //Creem variable de sessió que es diu "usuari" i té el valor "Miquel" 
