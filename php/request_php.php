...
<head>
    ...
    <meta name="description" content="$_REQUEST PHP" />
    <title>$_REQUEST PHP</title>
...
<body>
    <div class="container">
        ...
        if (isset($_REQUEST["email"])) {
            ...
            "No has introduit cap email";
        }

        ?>
        <form method="POST" action="request_php.php">
            <label for="email">Correu:</label>
            <input type="text" name="email" id="email" placeholder="Escriu el teu correu">
