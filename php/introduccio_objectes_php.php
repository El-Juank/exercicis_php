...
class Cotxe
{
    ...
    function __destruct()
    {
        echo "S'ha destruit el cotxe " . $this->marca . " " . $this->model . "<br>";
    }
    public function fer_viatge($kms_fets)
    {
        $this->km = $this->km + $kms_fets;
    }
    public function calcular_preu($desgast_km = 0.5)
    {
        $this->valor = $this->preu - ($this->kms / $desgast_km);
        return $this->valor;
    }
}

$cotxe_juan = new Cotxe("Renault", "Megane", "Blanc");

$cotxe_juan->fer_viatge(300);
$cotxe_juan->preu = 10000;

/*
$cotxe_juan->marca = "Renault";
$cotxe_juan->model = "Megane";
$cotxe_juan->color = "Blanc";
$cotxe_juan->places;
*/
...
<body>
    <div class="container">
        <h1>Cotxes</h1>
        <?php echo $cotxe_juan->marca; ?>
        Kms totals: <?php echo $cotxe_juan->km . "<br>"; ?>
        <?php
        $valor_actual = $cotxe_juan->calcular_preu();
        echo $valor_actual; ?>
    </div>
