...
<body>
    ...
    <nav id="topNav" class="navbar fixed-to navbar-expand-lg sticky">
        <a class="navbar-brand mx-auto" href="/">
            <img class="" src="img/gelats/gelats_costa_logo.png" alt="logo/brand" />
        </a>
    ...
    <!--Fi del Header-->
    <div class="container">
        <form method="POST" action="exercici_gelateria_1_php.php">
            <?php
            if (isset($_POST['tipus'])) {
                $tipus = $_POST['tipus'];
                switch ($tipus) {
                    case 'cucurutxo':
                        $tipus = "img/gelats/cucurutxomaduixa.jpg";
                        break;
                    case 'tarrina':
                        $tipus = "img/gelats/tarrinamaduixa.jpg";
                        break;
                    case 'batut':
                        $tipus = "img/gelats/batutmaduixa.jpg";
                        break;
                    default:
                        //El valor per defecte es el cucurutxo
                        $tipus = "img/gelats/cucurutxomaduixa.jpg";
                        break;
                }
            }
