    ...
    <div class="category-insert container px-3 py-3 pt-md-5 pb-md-4 mt-md-5 mt-md-4 mx-auto">
        <div class="mb-md-4 mb-4">
            ...
            <form method="POST" action="insertar_categoria.php">
                <input type="text" name="nomCategoria" placeholder="Enter the category name" class="form-control mb-3">
                <textarea name="descripcio" placeholder="Enter the category description" class="form-control mb-3"></textarea>
