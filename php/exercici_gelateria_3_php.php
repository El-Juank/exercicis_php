...
<body>
    ...
    <!--Fi del Header-->
    <div class="container">
        <form method="GET" action="exercici_gelateria_3_php.php">
            <?php
            if (isset($_GET['tipus'])) {
                $tipus = $_GET['tipus'];
                $sabor = $_GET['sabor'];
                    ...
                    case 'cucurutxo':
                        if ($sabor == 'maduixa') {
                            if ($mida == "petit") {
                                ...
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/cucurutxomaduixa2.jpg";
                            } else if ($mida == "gran") {
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/cucurutxomaduixa3.jpg";
                            } else {
                            ...
                            if ($mida == "petit") {
                                ...
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/cucurutxollimona2.jpg";
                            } else if ($mida == "gran") {
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/cucurutxollimona3.jpg";
                            } else {
                                //Tamaño pequeño por defecto
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/cucurutxollimona.jpg";
                            }
                            ...
                            if ($mida == "petit") {
                                ...
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/cucurutxoxocolata2.jpg";
                            } else if ($mida == "gran") {
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/cucurutxoxocolata3.jpg";
                            } else {
                                //Tamaño pequeño por defecto
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/cucurutxoxocolata.jpg";
                            }
                    ...
                    case 'tarrina':
                        if ($sabor == 'maduixa') {
                            if ($mida == "petit") {
                                ...
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/tarrinamaduixa2.jpg";
                            } else if ($mida == "gran") {
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/tarrinamaduixa3.jpg";
                            } else {
                                //Tamaño pequeño por defecto
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/tarrinamaduixa.jpg";
                            }
                            ...
                            if ($mida == "petit") {
                                ...
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/tarrinallimona2.jpg";
                            } else if ($mida == "gran") {
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/tarrinallimona3.jpg";
                            } else {
                                //Tamaño pequeño por defecto
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/tarrinallimona.jpg";
                            }
                            ...
                            if ($mida == "petit") {
                                ...
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/tarrinaxocolata2.jpg";
                            } else if ($mida == "gran") {
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/tarrinaxocolata3.jpg";
                            } else {
                                //Tamaño pequeño por defecto
                                $img = "https://raw.githubusercontent.com/El-Juank/exercicis/master/img/gelats/tarrinaxocolata.jpg";
                            }
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <h2>Mida</h2>
                    <select name="mida" id="mida">
                        <option>Tria la mida</option>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 cizgi linia">
                        <div class="card border-0">
                            <div class="card-body text-center">
                                ...
                                <a class="d-block lead" style="margin-left: -20px" href="tel:+900000000000"><i class="fa fa-phone mr-2"></i>+90 (000) 000 0 000</a>
                                <a class="d-block lead" href="mailto:info@gelatscosta.com"><i class="fa fa-envelope mr-2"></i>info@gelatscosta.com</a>
                            </div>
                        </div>
                    </div>
