...
<head>
    ...
    <meta name="description" content="Actualitzar producte" />
...
<body>
    ...
    <div class="category-insert container px-3 py-3 pt-md-5 pb-md-4 mt-md-5 mt-md-4 mx-auto">
        <div class="mb-md-4 mb-4">
            ...
            <h2>Use the following form to update a product</h2>
            <?php
            ...
            <select class="browser-default custom-select mt-3" >
                ...
                while ($category = $categories->fetch_assoc()) { ?>
                    <option <?php if ($category["CategoryID"] == $product["CategoryID"]) {
                                echo "selected";
