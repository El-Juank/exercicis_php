...
<body>
    ...
    <!-- Icons Grid -->
    <section class="upload-image bg-light text-center">
        <div class="container">
            <form action="arxiu_locals_pujar_php.php" method="POST" enctype="multipart/form-data">
                <label>Puja una foto</label> <br>
