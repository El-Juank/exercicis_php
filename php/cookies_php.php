<?php setcookie("nomusuari", "Miquel", time() + (60 * 60 * 24 * 30)); //Serveix per crear, modificar i eliminar cookies
echo "Cookie creada correctament";
?>
<!DOCTYPE html>
<html lang="ca">
...
<head>
    ...
    <meta name="description" content="Cookies amb PHP" />
    <title>Cookies amb PHP</title>
