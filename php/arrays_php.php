...
<head>
    ...
    <meta name="description" content="Arrays PHP" />
...
<body>
    <div class="container">
        <?php
        $jugadors = array("Pepito", "Mickey", "Ruggiero");
        array_push($jugadors, "Juancito");
        for ($i = 0; $i < count($jugadors); $i++) { //En php en lugar de "_.length" se usa "count(_)"
            echo $jugadors[$i] . "<br>";
        }
        ?>
    </div>
